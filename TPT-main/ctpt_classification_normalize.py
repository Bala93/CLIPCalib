...
def test_time_tuning(model, inputs, optimizer, scaler, args):
    ...
    for j in range(args.tta_steps):
        ...
        with torch.cuda.amp.autocast():
            ...
            loss = avg_entropy(output) - 50 * torch.mean(torch.norm(vec_d, p=2, dim=1))
...
#        fname = 'tpt-coop'
#
    torch.save(rlogits,'/home/ar88770/TPT/logits/{}/{}_neg_ctpt.pt'.format(arch_dict[args.arch],dataset_name))
